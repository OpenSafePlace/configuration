...
# General process
## Vars xauthority
local__project_container_id=$(docker ps -aqf "name=${global__project_name}-mariadb")
...
##
## Set correct rules
inside 1 root mariadb "chown public:public /home/public/.Xauthority"
##
info "В контейнере 'MariaDB' обновлен файл хранения учетных данных 'Xauthority'"
}
##
## Unset local vars
