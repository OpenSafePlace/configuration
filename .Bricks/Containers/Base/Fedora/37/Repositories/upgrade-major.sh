...
##
[[ ! -d $global__project_main_folder/.Bricks/Containers/Base/$global__project_os/$local__project_new_os_version ]] && {
##
## Output warning info
warning "Конфигурация не подготовлена к обновлению контейнера 'Base' до версии '$local__project_new_os_version'"
...
##
input "Вы точно хотите обновить контейнер 'Base' с версии '$global__project_os_version' до версии '$local__project_new_os_version'? (y/n)\n"
input "=> "
##
read -p '' choice
##
...
inside 1 root base "dnf system-upgrade download --releasever=$local__project_new_os_version -y"
