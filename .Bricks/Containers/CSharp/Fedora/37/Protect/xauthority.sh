...
# General process
## Vars xauthority
local__project_container_id=$(docker ps -aqf "name=${global__project_name}-csharp")
...
##
## Set correct rules
inside 1 root csharp "chown public:public /home/public/.Xauthority"
##
info "В контейнере 'CSharp' обновлен файл хранения учетных данных 'Xauthority'"
}
##
## Unset local vars
