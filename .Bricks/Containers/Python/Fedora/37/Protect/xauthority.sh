...
# General process
## Vars xauthority
local__project_container_id=$(docker ps -aqf "name=${global__project_name}-python")
...
##
## Set correct rules
inside 1 root python "chown public:public /home/public/.Xauthority"
##
info "В контейнере 'Python' обновлен файл хранения учетных данных 'Xauthority'"
}
##
## Unset local vars
