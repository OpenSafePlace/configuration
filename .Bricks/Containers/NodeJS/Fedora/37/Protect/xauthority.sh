...
# General process
## Vars xauthority
local__project_container_id=$(docker ps -aqf "name=${global__project_name}-nodejs")
...
##
## Set correct rules
inside 1 root nodejs "chown public:public /home/public/.Xauthority"
##
info "В контейнере 'NodeJS' обновлен файл хранения учетных данных 'Xauthority'"
}
##
## Unset local vars
