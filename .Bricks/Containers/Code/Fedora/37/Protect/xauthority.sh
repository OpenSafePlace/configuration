...
# General process
## Vars xauthority
local__project_container_id=$(docker ps -aqf "name=${global__project_name}-code")
...
##
## Set correct rules
inside 1 root code "chown public:public /home/public/.Xauthority"
##
info "В контейнере 'Code' обновлен файл хранения учетных данных 'Xauthority'"
}
##
## Unset local vars
