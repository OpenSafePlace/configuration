...
inside 1 private $local__container_name_lowercase "mkdir -p /tmp/backups/${global__project_name}-${local__container_name_lowercase}--${local__datetime_iso}/vnc"
inside 1 root $local__container_name_lowercase "cp -rf /home/private/.vnc/* /tmp/backups/${global__project_name}-${local__container_name_lowercase}--${local__datetime_iso}/vnc"
