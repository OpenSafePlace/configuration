...
##
## Update params (container: csharp)
inside 1 public csharp "echo -n '' > /home/public/.zsh_params"
inside 1 public csharp "echo -n 'export global__project_power=$local__project_power_percent' >> /home/public/.zsh_params"
##
## Update params (container: code)
inside 1 public code "echo -n '' > /home/public/.zsh_params"
inside 1 public code "echo -n 'export global__project_power=$local__project_power_percent' >> /home/public/.zsh_params"
##
## Unset local vars
