...
sh -c "chmod 700 -R $global__project_main_folder/Logs" &>/dev/null
sh -c "chmod 700 -R $global__project_main_folder/Other" &>/dev/null
sh -c "chmod 700 -R $global__project_main_folder/Bridge" &>/dev/null
sh -c "chmod 700 -R $global__project_main_folder/Backups" &>/dev/null
