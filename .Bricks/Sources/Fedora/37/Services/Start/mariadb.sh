...
##
## Start process
inside 5 mysql $local__container_name_lowercase "cpulimit --limit=$local__project_power_percent --lazy --include-children mysqld_safe >> /var/log/mariadb/run.log"
##
info "В контейнере '$local__container_name' сервис 'mariadb' запущен"
